          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="text-center p-6 bg-gradient-to-r from-valoov-teal/20 to-valoov-orange/20 rounded-lg">
                <h3 className="text-xl font-semibold text-white mb-2">Company Valuation Range</h3>
                <p className="text-3xl font-bold text-white">€2.8M - €4.2M</p>
                <p className="text-gray-400 mt-1">Pre-Money Valuation</p>
              </div>

              {/* Limited Method Preview */}
              <div className="space-y-3">
                <h4 className="font-semibold text-white">Valuation Methods (Preview)</h4>
                {valuationMethods.slice(0, 2).map((method, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-card/20 rounded-lg">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-400">({method.weight})</span>
                    </div>
                  </div>
                ))}
        ...
        <Card className="bg-gradient-to-r from-valoov-teal/20 to-valoov-orange/20 border-valoov-teal/30">
          <CardContent className="p-6 text-center">
            <div className="flex items-center justify-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-white">Unlock Full Valuation Report</h3>
            </div>
            <p className="text-gray-300 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="text-center">
                <h4 className="font-semibold text-white">Professional Report</h4>
              ...
              <div className="text-center border border-valoov-orange rounded-lg p-4">
                ...
                <h4 className="font-semibold text-white">Pro + Analyst Review</h4>
                <p className="text-3xl font-bold text-valoov-orange">€199</p>
                <p className="text-sm text-gray-400">Professional validation</p>
              </div>
              <div className="text-center">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white">Valuation Report</h1>
          <p className="text-gray-400 mt-1">Complete professional valuation analysis</p>
        </div>
      ...
      <Card className="bg-card/30 backdrop-blur border-border/50">
        <CardContent className="p-6">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-white mb-2">TechCorp Solutions</h2>
            ...
            <div className="bg-gradient-to-r from-valoov-teal/20 to-valoov-orange/20 p-6 rounded-lg">
              ...
              <p className="text-gray-400">Weighted Average Pre-Money Valuation</p>
              <p className="text-sm text-gray-500 mt-2">Range: €2.8M - €4.2M</p>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <Card className="bg-card/30 backdrop-blur border-border/50">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Detailed Method Breakdown</span>
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-card/30 backdrop-blur border-border/50">
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-500 mt-2">Including method weightings, trend analysis, and market comparisons</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
